...
class CustomerOperation:
    ...
    def start_customer_on_boarding(self, headers, customer):
        fns = [self.register_customer, self.update_images, self.approve_customer, self.validate_customer,
               self.convert_customer, self.activate_user]
        operation_names = ['Create Customer', 'Upload Images', "Approve Customer", "Validating Customer",
                           "Convert Customer", "Activate User"]
        ...
        for t in zip(fns, operation_names):
            ...
            if status_code < 200 or status_code > 299:
                ...
                res['status_text'] = "Error in executing..."
            res['step'] = t[1]
            return res
        return res
